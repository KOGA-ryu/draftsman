...
Use `data/ui_theme.json` for the global theme palette and font controls:
...
Do not hard-code project colors or fonts into C++ or stylesheet files. Change the theme file and let the stylesheet derive the rest.
